  ...
  const handleAddClerk = async () => {
    ...
    try {
      ...
      toast.success('Clerk Added Successfully!', {
        description: `${newClerk.name} has been added to the system with login credentials: ${newClerkForm.email} / ${newClerkForm.password}`,
        duration: 6000,
      });
        ...
        <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new clerk account with login credentials
              </DialogDescription>
            </DialogHeader>
